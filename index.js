...
app.get('/', (req, res) => {
  res.json({ status: 'ok', service: 'InfluencerFounder Video Analyser', version: '2.26.0', timestamp: new Date().toISOString() });
});
