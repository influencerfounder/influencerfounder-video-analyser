...
app.get('/', (req, res) => {
  res.json({ status: 'ok', service: 'InfluencerFounder Video Analyser', version: '2.16.1', timestamp: new Date().toISOString() });
});
